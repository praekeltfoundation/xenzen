...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'XenServer.mem_free'
        db.add_column(u'xenserver_xenserver', 'mem_free',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'XenServer.cpu_util'
        db.add_column(u'xenserver_xenserver', 'cpu_util',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'XenServer.mem_free'
        db.delete_column(u'xenserver_xenserver', 'mem_free')

        # Deleting field 'XenServer.cpu_util'
        db.delete_column(u'xenserver_xenserver', 'cpu_util')
