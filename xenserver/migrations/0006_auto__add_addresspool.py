...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'xenserver_addresspool', (
            ...
            ('subnet', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('zone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xenserver.Zone'])),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xenserver.XenServer'], null=True)),
        ))
    ...
    models = {
        ...
        u'xenserver.addresspool': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'server': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['xenserver.XenServer']", 'null': 'True'}),
            'subnet': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
