...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XenVM.project'
        db.add_column(u'xenserver_xenvm', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xenserver.Project'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'XenVM.project'
        db.delete_column(u'xenserver_xenvm', 'project_id')
